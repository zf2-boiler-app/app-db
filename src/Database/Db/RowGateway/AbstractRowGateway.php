<?php
namespace BoilerAppDb\Db\RowGateway;
abstract class AbstractRowGateway extends \Zend\Db\RowGateway\RowGateway{
	/**
	 * @var \BoilerAppDb\Db\TableGateway\AbstractTableGateway
	 */
	protected $model;
	 ...
	 * @param \BoilerAppDb\Db\TableGateway\AbstractTableGateway $oModel
	 */
	public function __construct(array $aPrimaryKey,\BoilerAppDbs\Db\TableGateway\AbstractTableGateway $oModel){
		$this->model = $oModel;
		$this->featureSet = new \Zend\Db\RowGateway\Feature\FeatureSet(array(
			new \BoilerAppDb\Db\RowGateway\Feature\EventFeature()
		));
