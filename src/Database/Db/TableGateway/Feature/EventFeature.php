...
class EventFeature extends \Zend\Db\TableGateway\Feature\EventFeature{
	 ...
	 * @param \BoilerAppDb\Db\TableGateway\Feature\EventFeature\TableGatewayEvent $oTableGatewayEvent
	 */
	public function __construct(\Zend\EventManager\EventManagerInterface $oEventManager = null, \BoilerAppDb\Db\TableGateway\Feature\EventFeature\TableGatewayEvent $oTableGatewayEvent = null){
		parent::__construct($oEventManager,$oTableGatewayEvent?:new \BoilerAppDb\Db\TableGateway\Feature\EventFeature\TableGatewayEvent());
		$this->eventManager->setIdentifiers('BoilerAppDb\Db\TableGateway\TableGateway');
	}
