<?php
namespace BoilerAppDb\Db\RowGateway\Feature;
class EventFeature extends \Zend\Db\RowGateway\Feature\AbstractFeature implements \Zend\EventManager\EventsCapableInterface{
     ...
     */
    public function __construct(\Zend\EventManager\EventManagerInterface $oEventManager = null, \BoilerAppDb\Db\RowGateway\Feature\EventFeature\RowGatewayEvent $oRowGatewayEvent = null){
        ...
        $this->eventManager->setIdentifiers(array('BoilerAppDb\Db\RowGateway\RowGateway'));
        $this->event = $oRowGatewayEvent?:new \BoilerAppDb\Db\RowGateway\Feature\EventFeature\RowGatewayEvent();
    }
     ...
     * @return \BoilerAppDb\Db\RowGateway\Feature\EventFeature\RowGatewayEvent
     */
